...
/* â”€â”€â”€ shared UI helpers â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */
...
const Settings = () => {
  ...
  /* â”€â”€ sync from user on load â”€â”€ */
  useEffect(() => {
    if (!user) return
    setNotif({
      ...
      <SectionCard className="p-8">
        <div className="flex flex-col md:flex-row items-center gap-8">
          ...
          <div className="flex-1 text-center md:text-left">
            <h3 className="text-2xl font-bold text-slate-100">{user?.fullName || "â€”"}</h3>
            <p className="text-slate-400 mb-1">@{user?.userName || "â€”"}</p>
            <p className="text-slate-500 text-sm mb-5">{user?.email || "â€”"}</p>
            <button
              onClick={() => navigate("/profile-settings")}
  ...
  /* â•â•â•â•â•â•â•â•â•â•â•â•â•â• PLAYBACK â•â•â•â•â•â•â•â•â•â•â•â•â•â• */
