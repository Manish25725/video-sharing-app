...
const targetFile = 'D:/video_sharing_app/frontened/src/pages/AdminLogin.jsx';
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md relative z-10 text-center">
        ...
        <div className="flex justify-center mb-6">
          ...
          >
             ...
             <ShieldCheck size={32} style={{ color: "#ec5b13" }} className="relative z-10" />
          </div>
        </div>
...
const updatedContent = content.replace(/return \([\s\S]*?\);\n};/, newReturn + "\n};");
fs.writeFileSync(targetFile, updatedContent, 'utf8');
console.log('Admin template updated!');
